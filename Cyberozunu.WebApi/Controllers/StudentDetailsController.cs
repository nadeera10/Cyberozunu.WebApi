...
using Cyberozunu.WebApi.Models;

namespace Cyberozunu.WebApi.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class StudentDetailsController : ControllerBase
    {
        private readonly CyberozunuContext _context;

        public StudentDetailsController(CyberozunuContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<StudentDetail>> PostStudentDetail(StudentDetail studentDetail)
        {
          if (_context.StudentDetails == null)
          {
              return Problem("Entity set 'CyberozunuContext.StudentDetails'  is null.");
          }
